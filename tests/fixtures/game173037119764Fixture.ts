...
/**
 * Deterministic fake evaluations for the plies in game 173037119764.
...
export const GAME_173037119764_EVALUATIONS: Record<string, EvaluationResult> = {
  ...
  // 8. Nbxd2 (the move investigated for false brilliant)
  ...
  // 13... Nb6 (Black blunder: loses advantage to +2.50)
  ...
  'r1bq1rk1/pp2nppp/1np5/4R3/3P4/1Q1B1N2/PP1N1PPP/R5K1 b - - 3 14': {
    ...
    lines: [
      ...
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 310 }, pv: ['e7g6', 'e5e1', 'c8e6'] },
    ],
  },
  // 14... Ng6
  'r1bq1rk1/pp3ppp/1np3n1/4R3/3P4/1Q1B1N2/PP1N1PPP/R5K1 w - - 4 15': {
    bestMove: 'd3g6',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 310 }, pv: ['d3g6', 'h7g6', 'a1e1'] },
  ...
  'r1bq1rk1/pp3ppp/1np3B1/4R3/3P4/1Q3N2/PP1N1PPP/R5K1 b - - 0 15': {
    bestMove: 'h7g6',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 310 }, pv: ['h7g6', 'a1e1', 'c8e6'] },
  ...
  'r1bq1rk1/pp3pp1/1np3p1/4R3/3P4/1Q3N2/PP1N1PPP/R5K1 w - - 0 16': {
    bestMove: 'a1e1',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 310 }, pv: ['a1e1', 'c8e6', 'b3c2'] },
  ...
  'r1bq1rk1/pp3pp1/1np3p1/4R3/3P4/1Q3N2/PP1N1PPP/4R1K1 b - - 1 16': {
    bestMove: 'c8e6',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 310 }, pv: ['c8e6', 'e5e6', 'f7e6'] },
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['b6d5', 'd2e4', 'd8c7'] },
    ],
  },
  // 16... Nd5
  'r1bq1rk1/pp3pp1/2p3p1/3nR3/3P4/1Q3N2/PP1N1PPP/4R1K1 w - - 2 17': {
    bestMove: 'h2h4',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['h2h4', 'b7b6', 'h4h5'] },
  ...
  'r1bq1rk1/pp3pp1/2p3p1/3nR3/3P3P/1Q3N2/PP1N1PP1/4R1K1 b - - 0 17': {
    bestMove: 'b7b6',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['b7b6', 'h4h5', 'g6h5'] },
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 420 }, pv: ['a7a5', 'h4h5', 'g6h5'] },
    ],
  },
  // 17... b6
  'r1bq1rk1/p4pp1/1pp3p1/3nR3/3P3P/1Q3N2/PP1N1PP1/4R1K1 w - - 0 18': {
    bestMove: 'h4h5',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['h4h5', 'g6h5', 'e5h5'] },
  ...
  'r1bq1rk1/p4pp1/1pp3p1/3nR2P/3P4/1Q3N2/PP1N1PP1/4R1K1 b - - 0 18': {
    bestMove: 'g6h5',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['g6h5', 'e5h5', 'c8g4'] },
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 500 }, pv: ['c8e6', 'h5g6', 'd8f6'] },
    ],
  },
  // 18... gxh5
  'r1bq1rk1/p4p2/1pp5/3nR2p/3P4/1Q3N2/PP1N1PP1/4R1K1 w - - 0 19': {
    bestMove: 'e5h5',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['e5h5', 'c8g4', 'h5g5'] },
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 300 }, pv: ['d2e4', 'c8g4', 'b3c2'] },
    ],
  },
  // 19. Rxh5
  'r1bq1rk1/p4p2/1pp5/3n3R/3P4/1Q3N2/PP1N1PP1/4R1K1 b - - 0 19': {
    bestMove: 'c8g4',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['c8g4', 'h5g5', 'd8d7'] },
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 550 }, pv: ['f7f6', 'b3d3', 'f8e8'] },
    ],
  },
  // 19... Bg4
  'r2q1rk1/p4p2/1pp5/3n3R/3P2b1/1Q3N2/PP1N1PP1/4R1K1 w - - 1 20': {
    bestMove: 'h5g5',
    lines: [
      { multiPv: 1, depth: 14, score: { kind: 'cp', value: 360 }, pv: ['h5g5', 'd8g5', 'f3g5'] },
      { multiPv: 2, depth: 14, score: { kind: 'cp', value: 120 }, pv: ['h5h4', 'g4f3', 'd2f3'] },
    ],
  },
  // 20. Rh4 (White slight inaccuracy: plays Rh4 instead of Rg5)
  'r2q1rk1/p4p2/1pp5/3n4/3P2bR/1Q3N2/PP1N1PP1/4R1K1 b - - 2 20': {
    bestMove: 'g4f3',
    lines: [
  ...
  // 20... Bxf3
  'r2q1rk1/p4p2/1pp5/3n4/3P3R/1Q3b2/PP1N1PP1/4R1K1 w - - 0 21': {
    bestMove: 'd2f3',
    lines: [
  ...
  // 21. Nxf3
  'r2q1rk1/p4p2/1pp5/3n4/3P3R/1Q3N2/PP3PP1/4R1K1 b - - 0 21': {
    bestMove: 'f8e8',
    lines: [
  ...
  // 21... Re8
  'r2qr1k1/p4p2/1pp5/3n4/3P3R/1Q3N2/PP3PP1/4R1K1 w - - 1 22': {
    bestMove: 'e1e8',
    lines: [
  ...
  // 22. Qd3
  'r2qr1k1/p4p2/1pp5/3n4/3P3R/3Q1N2/PP3PP1/4R1K1 b - - 2 22': {
    bestMove: 'e8e1',
    lines: [
  ...
  // 22... Rxe1+
  'r2q2k1/p4p2/1pp5/3n4/3P3R/3Q1N2/PP3PP1/4r1K1 w - - 0 23': {
    bestMove: 'f3e1',
    lines: [
  ...
  // 23. Nxe1
  'r2q2k1/p4p2/1pp5/3n4/3P3R/3Q4/PP3PP1/4N1K1 b - - 0 23': {
    bestMove: 'd8h4',
    lines: [
  ...
  // 23... Qxh4 (Black wins rook)
  'r5k1/p4p2/1pp5/3n4/3P3q/3Q4/PP3PP1/4N1K1 w - - 0 24': {
    bestMove: 'e1f3',
    lines: [
